...
namespace SimpleAtomPubSub.Serialization.Xml.Net
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="XmlConvertKeyValueElementAttribute" /> class with a key name and a
        ///     value name.
        /// </summary>
        ...
        public XmlConvertKeyValueElementAttribute(string keyName, string valueName)
        {
            ...
            {
                throw new ArgumentException("The dictionary key element name cannot be empty", nameof(keyName));
            }
            ...
            {
                throw new ArgumentException("The dictionary value element name cannot be empty", nameof(valueName));
            }
